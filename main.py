...
message3 = tk.Label(window, text="Facial Biometric System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
message3.place(x=60, y=10)

frame3 = tk.Frame(window, bg="#c4c6ce")
frame3.place(relx=0.72, rely=0.09, relwidth=0.09, relheight=0.07)

frame4 = tk.Frame(window, bg="#c4c6ce")
frame4.place(relx=0.39, rely=0.09, relwidth=0.25, relheight=0.07)
...
lbl = tk.Label(frame2, text="Registration Number:",width=20  ,height=1  ,fg="black"  ,bg="#c79cff" ,font=('comic', 17, ' bold ') )
lbl.place(x=80, y=55)
